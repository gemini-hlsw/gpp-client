...
The ``gpp_client.generated.custom_queries`` module defines statically typed query builders corresponding to GraphQL `Query` operations available in the GPP schema.
