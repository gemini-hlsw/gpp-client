...
from .new_observation_edit import NewObservationEdit
...
class _GPPClient(AsyncBaseClient):
    ...
    async def new_observation_edit(
        self,
        program_id: Union[Optional[Any], UnsetType] = UNSET,
        obs_id: Union[Optional[Any], UnsetType] = UNSET,
        **kwargs: Any
    ) -> AsyncIterator[NewObservationEdit]:
        query = gql(
            """
            subscription newObservationEdit($programId: ProgramId, $obsId: ObservationId) {
              observationEdit(input: {programId: $programId, observationId: $obsId}) {
                editType
                observationId
                value {
                  id
        ...
        variables: Dict[str, object] = {"programId": program_id, "obsId": obs_id}
        async for data in self.execute_ws(
            query=query,
            operation_name="newObservationEdit",
            variables=variables,
            **kwargs
        ):
            yield NewObservationEdit.model_validate(data)
