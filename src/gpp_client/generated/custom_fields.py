...
from .custom_typing_fields import (
    ...
    Flamingos2MosAcquisitionGraphQLField,
    Flamingos2MosGraphQLField,
    ...
    ItcGraphQLField,
    ItcPeakPixelGraphQLField,
    ItcResultGraphQLField,
    ItcResultSetGraphQLField,
    ItcScienceOnlySpectroscopyGraphQLField,
...
class ConfigurationFlamingos2MosFields(GraphQLField):
    ...
    def fields(
        ...
        """Subfields should come from the ConfigurationFlamingos2MosFields class"""
        self._subfields.extend(subfields)
        return self

    def alias(self, alias: str) -> "ConfigurationFlamingos2MosFields":
        self._alias = alias
        return self
...
class ConfigurationObservingModeFields(GraphQLField):
    ...
    @classmethod
    def flamingos_2_mos(cls) -> "ConfigurationFlamingos2MosFields":
        return ConfigurationFlamingos2MosFields("flamingos2Mos")
...
class DeleteSequenceResultFields(GraphQLField):
    ...
    @classmethod
    def observation(cls) -> "ObservationFields":
        """The observation whose sequence was deleted."""
        return ObservationFields("observation")
...
class Flamingos2LongSlitFields(GraphQLField):
    ...
    def explicit_telescope_configs(cls) -> "SlitTelescopeConfigsFields":
        """Optional explicitly specified telescope configs. If set they override the
        preset default."""
...
class Flamingos2MosFields(GraphQLField):
    ...
    @classmethod
    def custom_mask(cls) -> "Flamingos2CustomMaskFields":
        """The custom mask through which the observation is taken.  Its `attachmentId` is
        null until the mask has been designed."""
        return Flamingos2CustomMaskFields("customMask")
    ...
    @classmethod
    def default_telescope_configs(cls) -> "SlitTelescopeConfigsFields":
        """Default telescope configs for the selected offset preset."""
        return SlitTelescopeConfigsFields("defaultTelescopeConfigs")
    ...
    @classmethod
    def acquisition(cls) -> "Flamingos2MosAcquisitionFields":
    ...
    def fields(
        ...
        *subfields: Union[
            ...
            "ExposureTimeModeFields",
            "Flamingos2CustomMaskFields",
            "Flamingos2MosAcquisitionFields",
            "SlitTelescopeConfigsFields",
            "TelluricTypeFields",
        ],
    ) -> "Flamingos2MosFields":
        """Subfields should come from the Flamingos2MosFields class"""
        self._subfields.extend(subfields)
        return self

    def alias(self, alias: str) -> "Flamingos2MosFields":
        self._alias = alias
        return self
...
class Flamingos2MosAcquisitionFields(GraphQLField):
    ...
    def fields(
        self,
        *subfields: Union[
            Flamingos2MosAcquisitionGraphQLField, "ExposureTimeModeFields"
        ],
    ) -> "Flamingos2MosAcquisitionFields":
        """Subfields should come from the Flamingos2MosAcquisitionFields class"""
        self._subfields.extend(subfields)
        return self

    def alias(self, alias: str) -> "Flamingos2MosAcquisitionFields":
        self._alias = alias
        return self
...
class GmosNorthMosAcquisitionFields(GraphQLField):
    ...
    @classmethod
    def exposure_time_mode(cls) -> "ExposureTimeModeFields":
        """The exposure time mode for the acquisition sequence.  MOS acquisition must be
        Time & Count."""
        return ExposureTimeModeFields("exposureTimeMode")
...
class GmosSouthMosAcquisitionFields(GraphQLField):
    ...
    def exposure_time_mode(cls) -> "ExposureTimeModeFields":
        """The exposure time mode for the acquisition sequence.  MOS acquisition must be
        Time & Count; there is no acquisition ITC pass to solve a signal-to-noise one."""
        return ExposureTimeModeFields("exposureTimeMode")
...
class GnirsDynamicFields(GraphQLField):
    ...
    def acquisition_mirror_out(cls) -> "GnirsAcquisitionMirrorOutFields":
        """Spectroscopy configuration carried when the acquisition mirror is "out" of
...
class GnirsImagingAcquisitionFields(GraphQLField):
    """GNIRS Imaging acquisition customization.  Every field overrides an otherwise
    automatic choice."""
    ...
    def sky_offset(cls) -> "OffsetFields":
        """The sky offset of the field image, which doubles as the sky frame.  Set only when the acquisition type is FAINT."""
...
class Igrins2LongSlitFields(GraphQLField):
    ...
    @classmethod
    def default_telescope_configs(cls) -> "SlitTelescopeConfigsFields":
        """Default telescope configs: the nod-along-slit ABBA pattern,
...
class ImagingConfigOptionFields(GraphQLField):
    ...
    def flamingos_2(cls) -> "ImagingConfigOptionFlamingos2Fields":
        """For Flamingos2 options, the Flamingos2 configuration.  Null for other
        instruments."""
...
class ItcPeakPixelFields(GraphQLField):
    ...
    def fields(self, *subfields: ItcPeakPixelGraphQLField) -> "ItcPeakPixelFields":
        """Subfields should come from the ItcPeakPixelFields class"""
        self._subfields.extend(subfields)
        return self

    def alias(self, alias: str) -> "ItcPeakPixelFields":
        self._alias = alias
        return self
...
class ItcResultFields(GraphQLField):
    ...
    @classmethod
    def peak_pixel(cls) -> "ItcPeakPixelFields":
        ...
        return ItcPeakPixelFields("peakPixel")
...
class ItcScienceOnlySpectroscopyFields(GraphQLField):
    """ITC results for spectroscopy observations that have no acquisition estimate:
    ...
    def fields(
        self,
        *subfields: Union[ItcScienceOnlySpectroscopyGraphQLField, "ItcResultSetFields"],
    ) -> "ItcScienceOnlySpectroscopyFields":
        """Subfields should come from the ItcScienceOnlySpectroscopyFields class"""
        self._subfields.extend(subfields)
        return self

    def alias(self, alias: str) -> "ItcScienceOnlySpectroscopyFields":
        self._alias = alias
        return self
...
class ObservationFields(GraphQLField):
    ...
    def timing_windows(cls) -> "TimingWindowFields":
        """Deprecated (using `schedulingConstraints` instead).  Observation timing
        windows."""
...
class ObservingModeFields(GraphQLField):
    ...
    @classmethod
    def flamingos_2_mos(cls) -> "Flamingos2MosFields":
        """Flamingos 2 MOS mode"""
        return Flamingos2MosFields("flamingos2Mos")
...
class ProposalFields(GraphQLField):
    ...
    @classmethod
    def time_request(cls) -> "CalculatedCategorizedTimeRangeFields":
        """The observing time this proposal requests: `explicitTimeRequest` if set,
        otherwise `defaultTimeRequest`."""
        return CalculatedCategorizedTimeRangeFields("timeRequest")

    @classmethod
    def default_time_request(cls) -> "CalculatedCategorizedTimeRangeFields":
        """The request that applies when none is explicitly set: the sum of the time
        estimates of the program's observations, the same figure reported by the
        program's `timeEstimateRange`.  Observations that are not fully defined have
        no estimate and so contribute nothing to it."""
        return CalculatedCategorizedTimeRangeFields("defaultTimeRequest")

    @classmethod
    def explicit_time_request(cls) -> "TimeSpanFields":
        """The time explicitly requested for this proposal, if any: by the PI before
        submission, or by staff during review.  Set it when the sum of the
        observations' estimates does not describe the real ask -- most obviously for a
        Target of Opportunity proposal, whose observations cannot all be written down
        before the targets are known."""
        return TimeSpanFields("explicitTimeRequest")
...
class SchedulingConstraintsFields(GraphQLField):
    ...
    @classmethod
    def timing_windows(cls) -> "TimingWindowFields":
        """One or more windows during which the observation is permitted to execute.  If
        empty, there are no timing constraints for the observation."""
        return TimingWindowFields("timingWindows")
...
class StepRecordFields(GraphQLField):
    ...
    def gnirs(cls) -> "GnirsDynamicFields":
        """GNIRS instrument configuration for this step, if any.  This will be null
        unless the `instrument` discriminator is "GNIRS"."""
...
class TooTriggerChronicleEntrySelectResultFields(GraphQLField):
    """The matching trigger chronicle entries, limited to a maximum of 1000 entries."""
...
class TooTriggerSelectResultFields(GraphQLField):
    """The matching triggers, limited to a maximum of 1000 entries."""
...
class VisitFields(GraphQLField):
    ...
    def gnirs(cls) -> "GnirsStaticFields":
        """GNIRS static instrument configuration, for GNIRS visits.  See the
        `instrument` discriminator.  This will be null unless the instrument is
        `GNIRS`."""
